            ...
            <div>
              ...
              {validationResult.duplicateRecords?.length > 0 && (
                <div style={{ marginBottom: 24 }}>
                  ...
                  >
                    <option value="SKIP">
                      Skip existing vendors (Keep current data)
                    </option>
                    <option value="UPDATE">
                      Update existing vendors with new data
                    </option>
                    <option value="IMPORT_NEW_ONLY">
                      Only import completely new vendors
                    </option>
                  </select>
                </div>
              )}
          ...
          {step === 3 && importSummary && (
            <div style={{ textAlign: 'center', padding: '20px 0' }}>
              ...
              <p style={{ color: 'var(--text-muted)', marginBottom: 24 }}>
                Your vendors have been imported into the database.
              </p>
              ...
              >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 22, fontWeight: 600, color: '#166534' }}
                  >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 22, fontWeight: 600, color: '#0369a1' }}
                  >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 22, fontWeight: 600, color: '#854d0e' }}
                  >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 22, fontWeight: 600, color: '#a16207' }}
                  >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 22, fontWeight: 600, color: '#dc2626' }}
                  >
