...
function getRecordType(r: ReportRecord): {
  type: string;
  icon: React.ElementType;
  color: string;
} {
  if (r.currentStage >= 16)
    return { type: 'Bill', icon: CreditCard, color: '#7C3AED' };
  if (r.currentStage >= 6)
    return { type: 'PO', icon: ShoppingCart, color: '#059669' };
                    ...
                    <div style={{ flexShrink: 0, textAlign: 'right' }}>
                      <div
                        style={{
                          ...
                          fontWeight: 700,
                          background:
                            (statusColor[r.status] || '#6B7280') + '18',
