      ...
      items: [
        {
          ...
          icon: FileText,
          stageNum: 0,
          permKey: 'indent.create',
        },
        {
          label: 'Indent Verification',
          href: '/indent-verification',
          icon: CheckCircle2,
          stageNum: 1,
          permKey: 'workflow.stage1.view',
        },
        {
          label: 'Store Check',
          href: '/store-check',
        ...
        },
        {
          ...
          icon: Send,
          stageNum: 3,
          permKey: 'workflow.stage3.view',
        },
        {
          label: 'Techno-Comm Eval',
          href: '/techno-commercial-evaluation',
          icon: TrendingUp,
          stageNum: 4,
          permKey: 'workflow.stage4.view',
        },
        {
          label: 'Negotiation',
          href: '/negotiation',
        ...
        },
        {
          ...
          icon: ShoppingCart,
          stageNum: 6,
          permKey: 'workflow.stage6.view',
        },
        {
          label: 'PO Approval L1',
          href: '/po-approval-l1',
          icon: CheckCircle2,
          stageNum: 7,
          permKey: 'workflow.stage7.view',
        },
        {
          label: 'PO Approval L2',
          href: '/po-approval-l2',
          icon: CheckCircle2,
          stageNum: 8,
          permKey: 'workflow.stage8.view',
        },
        {
          label: 'Vendor Acceptance',
          href: '/vendor-acceptance',
          icon: Users,
          stageNum: 9,
          permKey: 'workflow.stage9.view',
        },
        {
          label: 'Vendor Follow-Up',
          href: '/vendor-follow-up',
          icon: Bell,
          stageNum: 10,
          permKey: 'workflow.stage10.view',
        },
        {
          ...
          icon: Receipt,
          stageNum: 11,
          permKey: 'workflow.stage11.view',
        },
        {
          label: 'Gate Entry',
          href: '/gate-entry',
          icon: Truck,
          permKey: 'gate_entry.view',
        },
        {
          label: 'Material Inspection',
          href: '/material-inspection',
          icon: ClipboardCheck,
          stageNum: 12,
          permKey: 'workflow.stage12.view',
        },
        {
          label: 'Secondary Inspection',
          href: '/secondary-inspection',
          icon: ClipboardList,
          stageNum: 13,
          permKey: 'workflow.stage13.view',
        },
        {
        ...
        },
        {
          ...
          icon: FileText,
          stageNum: 15,
          permKey: 'workflow.stage15.view',
        },
        {
          label: 'Bill to Accounts',
          href: '/bill-to-accounts',
          icon: CreditCard,
          stageNum: 16,
          permKey: 'workflow.stage16.view',
        },
        {
          label: 'Bill to Purchase',
          href: '/bill-to-purchase',
          icon: CreditCard,
          stageNum: 17,
          permKey: 'workflow.stage17.view',
        },
        {
          label: 'Bill Creation',
          href: '/bill-creation',
        ...
        },
        {
          ...
          icon: BarChart3,
          stageNum: 19,
          permKey: 'workflow.stage19.view',
        },
        {
          label: 'Bill Approval L1',
          href: '/bill-approval-l1',
          icon: CheckCircle2,
          stageNum: 20,
          permKey: 'workflow.stage20.view',
        },
        {
          label: 'Bill Approval L2',
          href: '/bill-approval-l2',
          icon: CheckCircle2,
          stageNum: 21,
          permKey: 'workflow.stage21.view',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: '/rejected-records',
          icon: AlertCircle,
          permKey: 'indent.view',
        },
        {
          label: 'Archived Indents',
          href: '/archived-indents',
          icon: Archive,
          permKey: 'indent.view',
        },
        {
    ...
    <>
      ...
      >
        {navGroups.map((group, gi) => {
          ...
          if (group.permKey && !isSuperAdmin && !can(group.permKey))
            return null;
