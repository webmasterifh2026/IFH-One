      ...
      <div className="p-8 max-w-5xl mx-auto">
        <div className="bg-white border border-gray-200 rounded-lg p-12 text-center flex flex-col items-center">
          ...
          <p className="text-[13px] text-gray-500">
            There are no files attached to this indent yet.
          </p>
        </div>
      </div>
    );
    ...
    <div className="p-8 max-w-5xl mx-auto">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {attachments.map((att) => (
          <div
            key={att.id}
            className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:border-gray-300 transition-colors group"
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-gray-400 mt-1">
                  Uploaded by {att.uploadedBy.fullName}
                </p>
              </div>
            </div>
            <div className="mt-4 pt-3 border-t border-gray-100 flex gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 flex items-center justify-center gap-1.5 py-1.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded text-[11px] font-bold text-gray-700 transition-colors"
              >
