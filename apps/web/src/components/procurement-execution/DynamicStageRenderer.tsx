...
// ─── Shared input style ──────────────────────────────────────────────────────
const inp =
  'w-full px-3 py-2 rounded-lg border text-[13px] bg-white focus:outline-none focus:ring-2 focus:ring-[#0F7B45]/20 focus:border-[#0F7B45]';
const sel = inp + ' cursor-pointer';
const lbl = 'block text-[11px] font-semibold uppercase tracking-wide mb-1';

// ─── Validation helpers ──────────────────────────────────────────────────────
function validateFields(rules: Array<{ label: string; valid: boolean }>): {
  ok: boolean;
  items: Array<{ label: string; valid: boolean }>;
} {
...
export function DynamicStageRenderer({
  procurement,
  onUpdate,
  actionLoading,
  onAction,
  ...
  switch (stage) {
    case 1:
      return <StageIndentVerification {...p} />;
    case 2:
      return <StageStoreAvailability {...p} />;
    case 3:
      return <StageRFQFloat {...p} />;
    case 4:
      return <StageTechnoCommercial {...p} />;
    case 5:
      return <StageNegotiation {...p} />;
    case 6:
      return <StagePOCreation {...p} />;
    case 7:
    case 8:
      return <StagePOApproval {...p} />;
    case 9:
      return <StageVendorAcceptance {...p} />;
    case 10:
      return <StageVendorFollowUp {...p} />;
    case 11:
      return <StageMaterialReceipt {...p} />;
    case 12:
      return <StageInspection level={1} {...p} />;
    case 13:
      return <StageInspection level={2} {...p} />;
    case 14:
      return <StageInspection level={3} {...p} />;
    case 15:
      return <StageDebitNote {...p} />;
    case 16:
      return <StageBillToAccounts {...p} />;
    case 17:
      return <StageBillToPurchase {...p} />;
    case 18:
      return <StageBillCreation {...p} />;
    case 19:
      return <StageTallyEntry {...p} />;
    case 20:
    case 21:
      return <StageBillApproval {...p} />;
    case 22:
      return <StagePaymentAdvice {...p} />;
    default:
      return <GenericStageView {...p} />;
  }
}
...
// ═══════════════════════════════════════════════════════════════════════════════
function StageIndentVerification({
  actionLoading,
  onAction,
  remarksText,
  setRemarksText,
  ...
  const s1Delay = (() => {
    ...
    const d = Math.round(
      (new Date(s1Actual).getTime() - new Date(s1Planned).getTime()) / 86400000
    );
    if (isNaN(d)) return '—';
    return d === 0 ? '0 days' : d > 0 ? `+${d} days` : `${d} days`;
  })();
  const fields = {
    plannedDate: s1Planned,
    actualDate: s1Actual,
    responsible: 'Pramod Kumar',
    remarks: remarksText,
  };
      ...
      >
        <div>
          ...
          <input
            type="date"
            value={s1Planned}
            onChange={(e) => setS1Planned(e.target.value)}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <input
            type="date"
            value={s1Actual}
            onChange={(e) => setS1Actual(e.target.value)}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <div
            style={{
              ...
              fontSize: 13,
              fontWeight: 700,
              color: s1Delay.startsWith('+') ? '#DC2626' : '#059669',
              background: 'var(--surface2)',
              height: 37,
              display: 'flex',
              alignItems: 'center',
        ...
        actions={[
          {
            ...
            onClick: () => onAction('APPROVE', fields),
          },
          {
            label: 'Hold',
            action: 'HOLD',
          ...
          },
          {
            ...
            loading: actionLoading,
            disabled: !remarksOk,
            onClick: () => onAction('REJECT', fields),
          },
        ]}
      />
    </div>
...
// ═══════════════════════════════════════════════════════════════════════════════
function StageStoreAvailability({
  procurement,
  actionLoading,
  onAction,
  remarksText,
      ...
      >
        ...
        <div>
          ...
          <input
            type="number"
            value={s2CurrentQty}
            onChange={(e) => setS2CurrentQty(Number(e.target.value))}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <div
            style={{
              ...
              fontSize: 13,
              fontWeight: 700,
              color: shortQty > 0 ? '#DC2626' : '#059669',
              background: 'var(--surface2)',
              height: 37,
              display: 'flex',
              alignItems: 'center',
        ...
        actions={[
          {
            ...
            loading: actionLoading,
            disabled: !remarksOk,
            onClick: () => onAction('AVAILABLE', fields),
          },
          {
            label: 'Float RFQ',
            ...
            loading: actionLoading,
            disabled: !remarksOk,
            onClick: () => onAction('NOT_AVAILABLE', fields),
          },
          {
            label: 'Hold',
            action: 'HOLD',
...
function StageRFQFloat({
  ...
  const s3Delay = (() => {
    ...
    const d = Math.round(
      (new Date(s3Actual).getTime() - new Date(s3Planned).getTime()) / 86400000
    );
    if (isNaN(d)) return '—';
    return d === 0 ? '0 days' : d > 0 ? `+${d} days` : `${d} days`;
  })();
  const fields = {
    rfqStatus: s3RfqStatus,
    plannedDate: s3Planned,
    actualDate: s3Actual,
    remarks: remarksText,
  };
  ...
  return (
    <div className="space-y-1">
      <div style={{ marginBottom: 12 }}>
        ...
        <select
          value={s3RfqStatus}
          onChange={(e) => setS3RfqStatus(e.target.value)}
          className={sel}
          style={{ borderColor: rfqFloated ? '#059669' : 'var(--border)' }}
        >
        ...
        {!rfqFloated && (
          <p style={{ fontSize: 11, color: '#D97706', marginTop: 4 }}>
            Set status to Floated after completing RFQ details to enable
            approval.
          </p>
        )}
      </div>
      ...
      >
        <div>
          ...
          <input
            type="date"
            value={s3Planned}
            onChange={(e) => setS3Planned(e.target.value)}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <input
            type="date"
            value={s3Actual}
            onChange={(e) => setS3Actual(e.target.value)}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <div
            style={{
              ...
              fontSize: 13,
              fontWeight: 700,
              color: s3Delay.startsWith('+') ? '#DC2626' : '#059669',
              background: 'var(--surface2)',
              height: 37,
              display: 'flex',
              alignItems: 'center',
...
// ═══════════════════════════════════════════════════════════════════════════════
function StageTechnoCommercial({
  procurement,
  actionLoading,
  onAction,
  remarksText,
  ...
  const allItemsApproved =
    itemIds.length > 0 &&
    itemIds.every(
      (id) => s4ItemApprovals[id]?.tech && s4ItemApprovals[id]?.comm
    );
  const remarksOk = remarksText.trim().length >= 3;
  ...
  const fields = {
    vendor: s4Vendor,
    quotation: s4Quotation,
    itemRate: s4ItemRate,
    deliveryTerms: s4DeliveryTerms,
    paymentTerms: s4PaymentTerms,
    comparisonSheet: s4CompSheet,
    techRemarks: s4TechRemarks,
    commRemarks: s4CommRemarks,
    itemApprovals: s4ItemApprovals,
    remarks: remarksText,
  };
    ...
    <div>
      ...
      >
        <div>
          ...
          <input
            value={s4Vendor}
            onChange={(e) => setS4Vendor(e.target.value)}
            placeholder="Vendor name"
            className={inp}
            style={{ borderColor: s4Vendor ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            value={s4Quotation}
            onChange={(e) => setS4Quotation(e.target.value)}
            placeholder="Quote ref / number"
            className={inp}
            style={{ borderColor: s4Quotation ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            ...
            step="any"
            value={s4ItemRate}
            onChange={(e) => setS4ItemRate(e.target.value)}
            placeholder="0.00"
            className={inp}
            style={{
              borderColor:
                parseFloat(s4ItemRate) > 0 ? 'var(--border)' : '#FCA5A5',
            }}
          />
        </div>
        <div>
          ...
          <input
            value={s4CompSheet}
            onChange={(e) => setS4CompSheet(e.target.value)}
        ...
        <div>
          ...
          <input
            value={s4DeliveryTerms}
            onChange={(e) => setS4DeliveryTerms(e.target.value)}
            placeholder="e.g. 45 days Ex-Works"
            className={inp}
            style={{
              borderColor: s4DeliveryTerms ? 'var(--border)' : '#FCA5A5',
            }}
          />
        </div>
        <div>
          ...
          <input
            value={s4PaymentTerms}
            onChange={(e) => setS4PaymentTerms(e.target.value)}
            placeholder="e.g. 30 days credit"
            className={inp}
            style={{
              borderColor: s4PaymentTerms ? 'var(--border)' : '#FCA5A5',
            }}
          />
        </div>
      </div>
      ...
      >
        <div>
          ...
          <textarea
            value={s4TechRemarks}
            onChange={(e) => setS4TechRemarks(e.target.value)}
            rows={2}
            placeholder="Technical evaluation summary..."
            className={inp}
            style={{
              borderColor:
                s4TechRemarks.length >= 3 ? 'var(--border)' : '#FCA5A5',
              resize: 'none',
            }}
          />
        </div>
        <div>
          ...
          <textarea
            value={s4CommRemarks}
            onChange={(e) => setS4CommRemarks(e.target.value)}
            rows={2}
            placeholder="Commercial evaluation summary..."
            className={inp}
            style={{
              borderColor:
                s4CommRemarks.length >= 3 ? 'var(--border)' : '#FCA5A5',
              resize: 'none',
            }}
          />
        </div>
        ...
        <div style={{ marginBottom: 14 }}>
            ...
            <table className="ifh-table">
              <thead>
                <tr style={{ background: 'var(--surface2)' }}>
                  {['Item', 'Spec / Makes', 'Technical', 'Commercial'].map(
                    (h) => (
                      <th
                        key={h}
                        style={{
              ...
              <tbody>
                {procurement.items.map((item, idx) => {
                  const appr = s4ItemApprovals[item.id] || {
                    tech: false,
                    comm: false,
                  };
                  return (
                    <tr
                      ...
                      style={{
                        borderBottom:
                          idx < procurement.items.length - 1
                    ...
                    >
                      ...
                      >
                        ...
                        {(item as any).approvedMakes && (
                          <span style={{ display: 'block', color: '#0F7B45' }}>
                            {(item as any).approvedMakes}
                          </span>
                        )}
                      </td>
                      <td style={{ padding: '8px 10px' }}>
                        {chip(appr.tech, () =>
                          setItemApproval(item.id, 'tech', !appr.tech)
                        )}
                      </td>
                      <td style={{ padding: '8px 10px' }}>
                        {chip(appr.comm, () =>
                          setItemApproval(item.id, 'comm', !appr.comm)
                        )}
                      </td>
                    </tr>
                  );
          ...
          {!allItemsApproved && (
            <p style={{ fontSize: 11, color: '#DC2626', marginTop: 5 }}>
              All items must be marked 🟢 Approved (both Technical and
              Commercial) before approving.
            </p>
          )}
        </div>
      )}
...
function StageNegotiation({
  ...
  const [rows, setRows] =
    useState<Record<string, NegotiationItemRow>>(initRows);
  ...
  const allComplete =
    procurement.items.length > 0 &&
    procurement.items.every((i) =>
      itemNegComplete(rows[i.id] || ({} as NegotiationItemRow))
    );
  const remarksOk = remarksText.trim().length >= 3;
  const validation = validateFields([
    {
      label: 'All items must be completed (vendor, prices, remarks)',
      valid: allComplete,
    },
    { label: 'Remarks', valid: remarksOk },
  ]);
  ...
  const fields = {
    remarks: remarksText,
    itemNegotiations: procurement.items.map((i) => ({
      itemId: i.id,
      itemName: i.itemName,
      ...rows[i.id],
    })),
    ...
    <div>
                  ...
                  style={{
                    borderBottom:
                      idx < procurement.items.length - 1
                        ? '1px solid var(--border)'
                        : 'none',
                    background: complete ? '#F0FDF4' : undefined,
                  }}
                >
                  <td
                    style={{
                  ...
                  <td style={{ ...td, minWidth: 120 }}>
                    <input
                      value={row.vendor}
                      onChange={(e) =>
                        setField(item.id, 'vendor', e.target.value)
                      }
                      placeholder="Vendor"
                      className={inp}
                      style={{
                        borderColor: row.vendor ? 'var(--border)' : '#FCA5A5',
                        fontSize: 11,
                      }}
                    />
                  </td>
                  <td style={{ ...td, minWidth: 90 }}>
                    <input
                      ...
                      onChange={(e) =>
                        setField(item.id, 'quotedPrice', e.target.value)
                      }
                      placeholder="0.00"
                      className={numInp}
                  ...
                  <td style={{ ...td, minWidth: 100 }}>
                    <input
                      ...
                      onChange={(e) =>
                        setField(item.id, 'negotiatedPrice', e.target.value)
                      }
                      placeholder="0.00"
                      className={numInp}
                      style={{
                        borderColor:
                          parseFloat(row.negotiatedPrice) > 0
                            ? 'var(--border)'
                            : '#FCA5A5',
                        fontSize: 11,
                      }}
                  ...
                  <td style={{ ...td, minWidth: 110 }}>
                    <input
                      ...
                      min="0"
                      step="any"
                      value={row.finalApprovedPrice}
                      onChange={(e) =>
                        setField(item.id, 'finalApprovedPrice', e.target.value)
                      }
                      placeholder="0.00"
                      className={numInp}
                      style={{
                        borderColor:
                          parseFloat(row.finalApprovedPrice) > 0
                            ? 'var(--border)'
                            : '#FCA5A5',
                        fontSize: 11,
                      }}
                  ...
                  <td style={{ ...td, minWidth: 80 }}>
                    <select
                      value={row.currency}
                      onChange={(e) =>
                        setField(item.id, 'currency', e.target.value)
                      }
                      className={sel}
                      style={{ fontSize: 11, borderColor: 'var(--border)' }}
                    >
                      <option>INR</option>
                      <option>USD</option>
                      <option>EUR</option>
                  ...
                  <td style={{ ...td, minWidth: 70 }}>
                    <input
                      ...
                      value={row.discount}
                      onChange={(e) =>
                        setField(item.id, 'discount', e.target.value)
                      }
                      placeholder="0"
                      className={numInp}
                      style={{ borderColor: 'var(--border)', fontSize: 11 }}
                  ...
                  <td style={{ ...td, minWidth: 150 }}>
                    <input
                      value={row.negotiationRemarks}
                      onChange={(e) =>
                        setField(item.id, 'negotiationRemarks', e.target.value)
                      }
                      placeholder="Negotiation remarks..."
                      className={inp}
                      style={{
                        borderColor:
                          row.negotiationRemarks.trim().length >= 3
                            ? 'var(--border)'
                            : '#FCA5A5',
                        fontSize: 11,
                      }}
      ...
      {!allComplete && (
        <p style={{ fontSize: 11, color: '#DC2626', marginBottom: 10 }}>
          All items must be marked 🟢 Complete before approving. Each item needs
          vendor, negotiated price, final approved price, and negotiation
          remarks.
        </p>
      )}
      <RemarksField value={remarksText} onChange={setRemarksText} />
...
function itemPOVerified(v: POItemVerification): boolean {
  return (
    ...
    v.rateVerified &&
    v.termsVerified &&
    v.poRate.trim().length >= 1 &&
    v.deliveryTerms.trim().length >= 1 &&
    v.paymentTerms.trim().length >= 1
  );
}

function StagePOCreation({
  procurement,
  actionLoading,
  onAction,
  remarksText,
  ...
  const negMeta: Array<{
    ...
    try {
      return negStage?.metadata
        ? JSON.parse(negStage.metadata)?.itemNegotiations || []
        : [];
    } catch {
      return [];
    }
  ...
  const [verifications, setVerifications] =
    useState<Record<string, POItemVerification>>(initVerifications);

  const setVer = (
    id: string,
    field: keyof POItemVerification,
    val: boolean | string
  ) =>
  ...
  const allVerified =
    procurement.items.length > 0 &&
    procurement.items.every((i) =>
      itemPOVerified(verifications[i.id] || ({} as POItemVerification))
    );
  const remarksOk = remarksText.trim().length >= 3;
  ...
  const fields = {
    ...
    poItems: procurement.items.map((i) => {
      ...
      return {
        ...
        unit: i.unit,
        vendor: neg?.vendor || '',
        negotiatedRate: neg?.finalApprovedPrice || '',
        poRate: ver?.poRate || neg?.finalApprovedPrice || '',
        currency: neg?.currency || 'INR',
        discount: neg?.discount || '',
        deliveryTerms: ver?.deliveryTerms || '',
        paymentTerms: ver?.paymentTerms || '',
        taxDetails: ver?.taxDetails || '',
        technicalSpec: (i as any).technicalSpec || '',
        approvedMakes: (i as any).approvedMakes || '',
      };
    }),
    snapshot: {
  ...
  const chk = (
    ...
    >
      ...
      />
      <span style={{ color: checked ? '#059669' : '#DC2626', fontWeight: 600 }}>
        {label}
      </span>
    </label>
  );
    ...
    <div>
      ...
      >
        <div>
          ...
          <input
            value={s6PoNumber}
            onChange={(e) => setS6PoNumber(e.target.value)}
            placeholder="e.g. PO-2026-0089"
            className={inp}
            style={{ borderColor: s6PoNumber ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            ...
            placeholder="Email ref / quote acceptance ref"
            className={inp}
            style={{ borderColor: vcOk ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
      </div>
      ...
      <div style={{ marginBottom: 14 }}>
        <label style={{ ...labelStyle, marginBottom: 8 }}>
          Item-wise PO Verification (Final Commercial Checkpoint)
        </label>
        {negMeta.length === 0 && (
          <div
            style={{
          ...
          >
            ⚠️ Negotiation stage data not found. Complete and approve stage 5
            first.
          </div>
        )}
        <div
          ...
          <table className="ifh-table">
            ...
            <tbody>
              {procurement.items.map((item, idx) => {
                ...
                const ver =
                  verifications[item.id] || ({} as POItemVerification);
                    ...
                    style={{
                      borderBottom:
                        idx < procurement.items.length - 1
                          ? '1px solid var(--border)'
                          : 'none',
                      background: verified ? '#F0FDF4' : undefined,
                    }}
                  >
                    <td style={{ ...tdc, minWidth: 140, fontWeight: 600 }}>
                      ...
                      {(item as any).approvedMakes && (
                        ...
                        >
                          Makes: {(item as any).approvedMakes}
                        </span>
                      )}
                    </td>
                    ...
                    <td
                      style={{
                        ...
                        minWidth: 90,
                        fontWeight: 700,
                        color: negRate > 0 ? '#059669' : '#DC2626',
                      }}
                    >
                      {negRate > 0
                        ? `${neg?.currency || 'INR'} ${negRate.toLocaleString('en-IN', { minimumFractionDigits: 2 })}`
                        : '—'}
                    </td>
                    <td style={{ ...tdc, minWidth: 100 }}>
                      <input
                        ...
                        value={ver.poRate}
                        onChange={(e) =>
                          setVer(item.id, 'poRate', e.target.value)
                        }
                        placeholder="0.00"
                        className={inp}
                        style={{
                    ...
                    <td style={{ ...tdc, minWidth: 130 }}>
                      <input
                        value={ver.deliveryTerms}
                        onChange={(e) =>
                          setVer(item.id, 'deliveryTerms', e.target.value)
                        }
                        placeholder="e.g. 45 days Ex-Works"
                        className={inp}
                        style={{
                          fontSize: 11,
                          borderColor: ver.deliveryTerms
                            ? 'var(--border)'
                            : '#FCA5A5',
                        }}
                      />
                    ...
                    <td style={{ ...tdc, minWidth: 130 }}>
                      <input
                        value={ver.paymentTerms}
                        onChange={(e) =>
                          setVer(item.id, 'paymentTerms', e.target.value)
                        }
                        placeholder="e.g. 30 days credit"
                        className={inp}
                        style={{
                          fontSize: 11,
                          borderColor: ver.paymentTerms
                            ? 'var(--border)'
                            : '#FCA5A5',
                        }}
                      />
                    ...
                    <td style={{ ...tdc, minWidth: 110 }}>
                      <input
                        value={ver.taxDetails}
                        onChange={(e) =>
                          setVer(item.id, 'taxDetails', e.target.value)
                        }
                        placeholder="GST 18% / nil"
                        className={inp}
                        style={{ fontSize: 11, borderColor: 'var(--border)' }}
                      />
                    </td>
                    <td style={{ ...tdc, minWidth: 160 }}>
                      ...
                      >
                        {chk('Vendor ✓', ver.vendorVerified, (v) =>
                          setVer(item.id, 'vendorVerified', v)
                        )}
                        {chk('Qty ✓', ver.qtyVerified, (v) =>
                          setVer(item.id, 'qtyVerified', v)
                        )}
                        {chk('Spec ✓', ver.specVerified, (v) =>
                          setVer(item.id, 'specVerified', v)
                        )}
                        {chk('Rate ✓', ver.rateVerified, (v) =>
                          setVer(item.id, 'rateVerified', v)
                        )}
                        {chk('Terms ✓', ver.termsVerified, (v) =>
                          setVer(item.id, 'termsVerified', v)
                        )}
                      </div>
                    </td>
                    <td
        ...
        {!allVerified && (
          <p style={{ fontSize: 11, color: '#DC2626', marginTop: 6 }}>
            All items must be 🟢 Verified — tick all 5 checkboxes and fill PO
            Rate, Delivery Terms, Payment Terms for each item.
          </p>
        )}
      </div>
      ...
      <ActionRow
        actions={[
          {
            label: 'Create PO → PO Approval L1',
            action: 'SUBMIT',
            color: '#0F7B45',
            loading: actionLoading,
            disabled: !validation.ok,
            onClick: () => onAction('SUBMIT', fields),
          },
        ]}
      />
    </div>
...
function StagePOApproval({
  ...
  const responsible =
    procurement.currentStage === 7 ? 'Pramod Kumar' : 'Ankur Gupta';
  const remarksOk = remarksText.trim().length >= 3;
  ...
  const stage = (n: number) =>
    procurement.stages.find((s) => s.stageNumber === n);
  ...
  const tat = (s?: ProcurementStage | null) => {
    ...
    const days = Math.round(
      (end.getTime() - new Date(s.startedAt).getTime()) / 86400000
    );
    return `${days} day${days === 1 ? '' : 's'}`;
  };

  const negItems: Array<{
    itemId: string;
    itemName: string;
    vendor: string;
    quotedPrice: string;
  ...
  const totalPOValue = poItems.reduce(
    (sum, i) => sum + parseFloat(i.poRate || '0') * (i.quantity || 0),
    0
  );
    ...
    <div>
      ...
      <div
        style={{
          ...
          padding: '10px 14px',
          borderRadius: 8,
          background: level === 'L1' ? '#EFF6FF' : '#F0FDF4',
          border: `1px solid ${level === 'L1' ? '#BFDBFE' : '#A7F3D0'}`,
        }}
      >
        <div
          style={{
            ...
            height: 36,
            borderRadius: '50%',
            background: level === 'L1' ? '#3B82F6' : '#059669',
            display: 'flex',
            alignItems: 'center',
        ...
        <div>
          ...
          >
            PO Approval — {level === 'L1' ? 'Level 1' : 'Level 2'}
          </div>
        ...
        >
          Ref: <strong>{procurement.referenceNo}</strong>
        </div>
      </div>
      ...
      <POReviewSection title="1. Indent Details">
        ...
        {procurement.items.length > 0 && (
          <table className="ifh-table">
            <thead>
              <tr style={{ background: 'var(--surface2)' }}>
                {['Item', 'Qty', 'UOM', 'Tech Spec', 'Approved Makes'].map(
                  (h) => (
                    <th key={h}>{h}</th>
                  )
                )}
        ...
        {meta1?.checklist && (
          ...
          >
            ...
            {Object.entries(meta1.checklist)
              .filter(([, v]) => v)
        ...
        {stage(1)?.remarks && (
          <KV label="Verification Remarks" value={stage(1)?.remarks} />
        )}
      </POReviewSection>
      ...
      <POReviewSection title="2. Store Check">
        {meta2?.itemChecks?.length > 0 ? (
          <table className="ifh-table">
            ...
            <tbody>
              {meta2.itemChecks.map((c: any) => (
                <tr key={c.itemId}>
                  <td>{c.itemName}</td>
                  <td>
                    {c.requiredQty} {c.unit}
                  </td>
          ...
          <span style={{ color: 'var(--text-muted)', fontSize: 11 }}>
            No store check data recorded.
          </span>
        )}
        <KV
          label="Summary Decision"
          value={meta2?.summaryDecision?.replace(/_/g, ' ')}
        />
        {stage(2)?.remarks && (
          <KV label="Store Remarks" value={stage(2)?.remarks} />
        )}
      </POReviewSection>
      ...
      <POReviewSection title="3. RFQ Float">
        ...
        {stage(3)?.remarks && (
          <KV label="RFQ Remarks" value={stage(3)?.remarks} />
        )}
      </POReviewSection>
      ...
      <POReviewSection title="4. Techno-Commercial Evaluation">
        ...
        {meta4?.techRemarks && (
          <KV label="Technical Remarks" value={meta4.techRemarks} />
        )}
        {meta4?.commRemarks && (
          <KV label="Commercial Remarks" value={meta4.commRemarks} />
        )}
        {meta4?.itemApprovals && (
        ...
        {stage(4)?.remarks && (
          <KV label="TCO Remarks" value={stage(4)?.remarks} />
        )}
      </POReviewSection>
      ...
      <POReviewSection title="5. Negotiation & Decision">
        {negItems.length > 0 ? (
          ...
          <span style={{ color: 'var(--text-muted)', fontSize: 11 }}>
            No negotiation data recorded.
          </span>
        )}
        {stage(5)?.remarks && (
          <KV label="Negotiation Remarks" value={stage(5)?.remarks} />
        )}
      </POReviewSection>
      ...
      <POReviewSection title="6. PO Creation Details">
        ...
        >
          ...
          <KV
            ...
            value={
              totalPOValue > 0
                ? `${poCurrency} ${totalPOValue.toLocaleString('en-IN', { minimumFractionDigits: 2 })}`
                : undefined
            }
          />
        </div>
              ...
              {poItems.map((i) => {
                ...
                return (
                  <tr key={i.itemId}>
                    ...
                    <td>
                      {i.currency}{' '}
                      {parseFloat(i.poRate || '0').toLocaleString('en-IN', {
                        minimumFractionDigits: 2,
                      })}
                    </td>
                    <td>
        ...
        {stage(6)?.remarks && (
          <KV label="PO Remarks" value={stage(6)?.remarks} />
        )}
      </POReviewSection>
          ...
          <tbody>
            {procurement.stages
              ...
              .map((s) => (
                <tr key={s.id}>
                  <td>
                    <strong>{s.stageNumber}.</strong> {s.stageName}
                  </td>
                  <td>
                    <span
                      style={{
          ...
          {procurement.attachments.map((a) => (
            ...
            >
              ...
              <span style={{ color: 'var(--text-muted)' }}>
                — {a.uploadedBy?.fullName} · {fmtDate(a.createdAt)}
              </span>
            </div>
          ))}
        </POReviewSection>
      ...
      >
        ...
        >
          Approval Decision — {level === 'L1' ? 'Level 1' : 'Level 2'}
        </div>
        <RemarksField value={remarksText} onChange={setRemarksText} />
        {!remarksOk && (
          <div
          ...
          >
            🔴 Approval Remarks are mandatory before approving, holding, or
            rejecting.
          </div>
        )}
...
// ═══════════════════════════════════════════════════════════════════════════════
function StageVendorAcceptance({
  actionLoading,
  onAction,
  remarksText,
  setRemarksText,
...
function StageVendorFollowUp({
  ...
  const fields = {
    vendorAgreedDate: s10VendorAgreed,
    expectedDeliveryDate: s10ExpectedDelivery,
    vendorName: s10VendorName,
    crmRemarks: remarksText,
  };
  ...
  const validation = validateFields([
    { label: 'Vendor Agreed Date', valid: s10VendorAgreed.trim().length > 0 },
    {
      ...
      valid: s10ExpectedDelivery.trim().length > 0,
    },
    ...
    <div className="space-y-1">
      ...
      >
        <div>
          ...
          <input
            type="date"
            value={s10VendorAgreed}
            onChange={(e) => setS10VendorAgreed(e.target.value)}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <input
            type="date"
            value={s10ExpectedDelivery}
            onChange={(e) => setS10ExpectedDelivery(e.target.value)}
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={s10VendorName}
            onChange={(e) => setS10VendorName(e.target.value)}
            placeholder="Vendor name"
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
      ...
      <div style={{ marginBottom: 12 }}>
        ...
        <textarea
          ...
          placeholder="Follow-up notes, vendor commitments..."
          rows={3}
          className="w-full px-4 py-3 rounded-xl border text-[13px] resize-none focus:outline-none"
          style={{
...
function StageMaterialReceipt({
  ...
  const parseMeta = (n: number) => {
    try {
      const s = procurement.stages.find((st) => st.stageNumber === n);
      return s?.metadata ? JSON.parse(s.metadata) : null;
    } catch {
      return null;
    }
  ...
  const allFullyReceived =
    ...
    procurement.items.every((i) => {
      const r = rows[i.id];
      return (
        grnItemStatus(i.quantity, parseFloat(r?.receivedQty || '0')) ===
        'FULLY_RECEIVED'
      );
    });
  const allValidated =
    procurement.items.length > 0 &&
    procurement.items.every((i) =>
      grnItemValid(rows[i.id] || ({} as GRNItemRow))
    );
  const remarksOk = remarksText.trim().length >= 3;
  ...
  const receiptItems = procurement.items.map((i) => {
    ...
    if (expectedDate && deliveryDate) {
      deliveryDelayDays = Math.round(
        (new Date(deliveryDate).getTime() - new Date(expectedDate).getTime()) /
          86400000
      );
    }
    return {
      ...
      receivedQty,
      pendingQty,
      status: grnItemStatus(i.quantity, receivedQty),
      vendor: r.vendorName,
      poNumber: r.poNumber,
      ...
      placeOfReceiving: r.placeOfReceiving,
      receiverName: r.receiverName,
      itemRemarks: r.itemRemarks,
      poRate: po?.poRate,
  ...
  const fields = {
    remarks: remarksText,
    receiptItems,
    grnCreatedAt: new Date().toISOString(),
  };
  ...
  const statusBadge = (s: ReturnType<typeof grnItemStatus>) => {
    const map = {
      FULLY_RECEIVED: { icon: '🟢', label: 'Fully Received', color: '#059669' },
      PARTIALLY_RECEIVED: {
        icon: '🟡',
        label: 'Partially Received',
        color: '#D97706',
      },
      NOT_RECEIVED: { icon: '🔴', label: 'Not Received', color: '#DC2626' },
    };
    const m = map[s];
    return (
      <span
  ...
  return (
    <div>
              ...
              {procurement.items.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ ...tdc, textAlign: 'right' as const }}>
                      {item.quantity}
                    </td>
                    <td
                      style={{
        ...
        {procurement.items.map((item, idx) => {
          ...
          return (
            <div
              key={item.id}
              style={{
                border: `1px solid ${valid ? '#A7F3D0' : 'var(--border)'}`,
                borderRadius: 8,
                marginBottom: 10,
                overflow: 'hidden',
              }}
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {valid ? '✅ Details Complete' : '⚠️ Incomplete'}
                  </span>
                </div>
              </div>
                ...
                >
                  <div>
                    ...
                    <input
                      value={r.vendorName}
                      onChange={(e) =>
                        setField(item.id, 'vendorName', e.target.value)
                      }
                      placeholder="Vendor"
                      className={inp}
                      style={{ fontSize: 11, borderColor: 'var(--border)' }}
                  ...
                  <div>
                    ...
                    <input
                      value={r.poNumber}
                      onChange={(e) =>
                        setField(item.id, 'poNumber', e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={r.receivedQty}
                      onChange={(e) =>
                        setField(item.id, 'receivedQty', e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={r.receiptDate}
                      onChange={(e) =>
                        setField(item.id, 'receiptDate', e.target.value)
                      }
                      className={inp}
                      style={{
                        fontSize: 11,
                        borderColor: r.receiptDate
                          ? 'var(--border)'
                          : '#FCA5A5',
                      }}
                    />
                  ...
                  <div>
                    ...
                    <input
                      value={r.gateEntryNo}
                      onChange={(e) =>
                        setField(item.id, 'gateEntryNo', e.target.value)
                      }
                      placeholder="GE-XXXX"
                      className={inp}
                      style={{
                        fontSize: 11,
                        borderColor: r.gateEntryNo
                          ? 'var(--border)'
                          : '#FCA5A5',
                      }}
                    />
                  ...
                  <div>
                    ...
                    <input
                      value={r.grnNo}
                      onChange={(e) =>
                        setField(item.id, 'grnNo', e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      value={r.batchLotNo}
                      onChange={(e) =>
                        setField(item.id, 'batchLotNo', e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      value={r.placeOfReceiving}
                      onChange={(e) =>
                        setField(item.id, 'placeOfReceiving', e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setField(item.id, 'receiverName', e.target.value)
                      }
                      placeholder="Name of receiver"
                      className={inp}
                      style={{
                        fontSize: 11,
                        borderColor: r.receiverName
                          ? 'var(--border)'
                          : '#FCA5A5',
                      }}
                    />
                  ...
                  <div style={{ gridColumn: 'span 3' }}>
                    ...
                    <input
                      value={r.itemRemarks}
                      onChange={(e) =>
                        setField(item.id, 'itemRemarks', e.target.value)
                      }
                      placeholder="Condition, observations, discrepancies..."
                      className={inp}
                      style={{
                        fontSize: 11,
                        borderColor:
                          r.itemRemarks.trim().length >= 3
                            ? 'var(--border)'
                            : '#FCA5A5',
                      }}
                    />
      ...
      {!allFullyReceived && (
        ...
        >
          ⚠️ Partial receipts are recorded. All items must be 🟢 Fully Received
          before moving to Material Inspection. Partially received items remain
          open for follow-up.
        </div>
      )}
      ...
      <ActionRow
        actions={[
          {
            label: 'Confirm Receipt → Inspection',
            action: 'SUBMIT',
            color: '#059669',
            loading: actionLoading,
            disabled: !validation.ok,
...
function StageInspection({
  ...
  const pendingItems = procurement.items.filter(
    (i: any) =>
      i.finalInspectionResult !== 'APPROVED' &&
      !i.debitNoteGenerated &&
      Number(i.quantity) > 0
  );
  ...
  const handleSubmit = async () => {
    ...
    for (const itemId of Object.keys(itemsStatus)) {
      if (
        itemsStatus[itemId].status === 'REJECTED' &&
        (!itemsStatus[itemId].remarks ||
          itemsStatus[itemId].remarks.trim().length === 0)
      ) {
  ...
  if (pendingItems.length === 0)
    return (
      <div className="text-sm text-gray-500">No items pending inspection.</div>
    );
            ...
            <div className="flex gap-4 mb-3">
              <label className="flex items-center gap-2 text-sm cursor-pointer">
                <input
                  type="radio"
                  name={`status-${item.id}`}
                  checked={itemsStatus[item.id]?.status === 'APPROVED'}
                  onChange={() => handleStatusChange(item.id, 'APPROVED')}
                  className="accent-[#0F7B45]"
                />
                Approve
              </label>
              <label className="flex items-center gap-2 text-sm cursor-pointer">
                <input
                  type="radio"
                  name={`status-${item.id}`}
                  checked={itemsStatus[item.id]?.status === 'REJECTED'}
                  onChange={() => handleStatusChange(item.id, 'REJECTED')}
...
function StageDebitNote({
  ...
  const fields = {
    debitNoteStatus: s15DebitStatus,
    responsible: 'Atul Tyagi',
    remarks: remarksText,
  };
  ...
  return (
    <div className="space-y-1">
      <div style={{ marginBottom: 12 }}>
        ...
        <select
          value={s15DebitStatus}
          onChange={(e) => setS15DebitStatus(e.target.value)}
          className={sel}
          style={{ borderColor: 'var(--border)' }}
        >
...
function StageBillToAccounts({
  ...
  const [s16Vendor, setS16Vendor] = useState(
    firstGrn?.vendorName || meta6?.poItems?.[0]?.vendor || ''
  );
  ...
  const inspectionCompleted = !!procurement.stages.find(
    (s) =>
      s.stageNumber >= 12 && s.stageNumber <= 14 && s.status === 'COMPLETED'
  );
  ...
  const fields = {
    vendorName: s16Vendor,
    billNumber: s16BillNo,
    billDate: s16BillDate,
    poNumber: s16PoNo,
    grnNumber: s16GrnNo,
    invoiceAmount: s16InvoiceAmt,
    taxAmount: s16TaxAmt,
    totalAmount: totalAmt.toFixed(2),
    attachmentRef: s16AttachRef,
    remarks: remarksText,
  };
    ...
    <div>
      {(!grnCompleted || !inspectionCompleted) && (
        ...
        >
          ...
          {!grnCompleted ? 'Material Receipt (GRN) must be completed. ' : ''}
          {!inspectionCompleted ? 'Material Inspection must be completed.' : ''}
        </div>
      )}
      <div
        style={{
      ...
      >
        <div>
          ...
          <input
            value={s16Vendor}
            onChange={(e) => setS16Vendor(e.target.value)}
            placeholder="Vendor name"
            className={inp}
            style={{ borderColor: s16Vendor ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            value={s16BillNo}
            onChange={(e) => setS16BillNo(e.target.value)}
            placeholder="e.g. VB-2026-001"
            className={inp}
            style={{ borderColor: s16BillNo ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            type="date"
            value={s16BillDate}
            onChange={(e) => setS16BillDate(e.target.value)}
            className={inp}
            style={{ borderColor: s16BillDate ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          <label style={labelStyle}>PO Number *</label>
          <input
            value={s16PoNo}
            onChange={(e) => setS16PoNo(e.target.value)}
            placeholder="PO-XXXX"
            className={inp}
            style={{ borderColor: s16PoNo ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          <label style={labelStyle}>GRN Number *</label>
          <input
            value={s16GrnNo}
            onChange={(e) => setS16GrnNo(e.target.value)}
            placeholder="GRN-XXXX"
            className={inp}
            style={{ borderColor: s16GrnNo ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            value={s16AttachRef}
            onChange={(e) => setS16AttachRef(e.target.value)}
            placeholder="File name / doc ref"
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
        <div>
          ...
          <input
            ...
            step="any"
            value={s16InvoiceAmt}
            onChange={(e) => setS16InvoiceAmt(e.target.value)}
            placeholder="0.00"
            className={inp}
            style={{
              borderColor: invoiceAmt > 0 ? 'var(--border)' : '#FCA5A5',
            }}
          />
        </div>
        <div>
          ...
          <input
            ...
            step="any"
            value={s16TaxAmt}
            onChange={(e) => setS16TaxAmt(e.target.value)}
            placeholder="0.00"
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
...
function StageBillToPurchase({
  ...
  const poTotalQty = (procurement.items || []).reduce(
    (s: number, i: any) => s + (i.quantity || 0),
    0
  );
  const grnTotalQty = (
    (meta11?.receiptItems || []) as Array<{ receivedQty: number }>
  ).reduce((s, r) => s + (r.receivedQty || 0), 0);

  const poTotalValue = (meta6?.poItems || []).reduce(
    (s: number, i: any) => s + parseFloat(i.poRate || '0') * (i.quantity || 0),
    0
  );
  ...
  const setCheck = (k: keyof typeof checks) =>
        ...
        <td style={{ padding: '8px 10px' }}>
          ...
          >
            ...
            <span
              style={{
                fontWeight: 600,
                color: checks[key] ? '#059669' : '#6B7280',
              }}
            >
              Verified
            </span>
  ...
  return (
    <div>
      ...
      >
        <table className="ifh-table">
          ...
          <tbody>
            ...
            {mkRow(
              'PO Value (₹)',
              `₹${poTotalValue.toLocaleString('en-IN', { minimumFractionDigits: 2 })}`,
      ...
      {!allChecked && (
        <p style={{ fontSize: 11, color: '#DC2626', marginBottom: 10 }}>
          All commercial parameters must be 🟢 verified before approval.
        </p>
      )}
      <div style={{ marginBottom: 12 }}>
        ...
        <textarea
          ...
          rows={2}
          placeholder="Purchase team verification summary..."
          className={inp}
          style={{
            borderColor: purchaseRemarksOk ? 'var(--border)' : '#FCA5A5',
            resize: 'none',
          }}
        />
      </div>
...
function StageBillCreation({
  ...
  const fields = {
    vendor: s18Vendor,
    billNumber: s18BillNo,
    poNumber: s18PoNo,
    grnNumber: s18GrnNo,
    invoiceAmount: s18InvoiceAmt,
    taxAmount: s18TaxAmt,
  ...
  return (
    <div>
      ...
      >
        🔒 Commercial values are locked from upstream stages. Only Due Date and
        Remarks can be entered.
      </div>
      <div
        style={{
          display: 'grid',
      ...
      >
        <div>
          ...
          <div style={ro}>{s18Vendor || '—'}</div>
        </div>
        <div>
          <label style={labelStyle}>Bill Number</label>
          <div style={ro}>{s18BillNo || '—'}</div>
        </div>
        <div>
          <label style={labelStyle}>PO Number</label>
          <div style={ro}>{s18PoNo || '—'}</div>
        </div>
        <div>
          <label style={labelStyle}>GRN Number</label>
          <div style={ro}>{s18GrnNo || '—'}</div>
        </div>
        <div>
          <label style={labelStyle}>Invoice Amount (₹)</label>
          <div style={{ ...ro, fontWeight: 700 }}>
            ₹ {invoiceAmt.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <input
            type="date"
            value={s18DueDate}
            onChange={(e) => setS18DueDate(e.target.value)}
            className={inp}
            style={{ borderColor: s18DueDate ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
      </div>
      <RemarksField value={remarksText} onChange={setRemarksText} />
...
function StageTallyEntry({
  ...
  const fields = {
    voucherNo: s19VoucherNo,
    entryDate: s19EntryDate,
    ledgerName: s19LedgerName,
    vendorLedger: s19VendorLedger,
    purchaseLedger: s19PurchaseLedger,
    gstLedger: s19GstLedger,
    responsible: 'Atul Tyagi',
    remarks: remarksText,
  };
    ...
    <div>
      ...
      >
        {[
          ...
          {
            label: 'Bill Amount',
            value: `₹ ${billAmount.toLocaleString('en-IN', { minimumFractionDigits: 2 })}`,
          },
          {
            label: 'Tax Amount',
          ...
          >
            ...
            <div
              style={{
                ...
                fontWeight: 700,
                color:
                  label === 'Net Payable' ? '#059669' : 'var(--text-primary)',
              }}
            >
              {value}
            </div>
      ...
      {!billCreated && (
        ...
        >
          🔴 Bill Creation (stage 18) must be completed before making Tally
          entry.
        </div>
      )}
      <div
      ...
      >
        <div>
          ...
          <input
            value={s19VoucherNo}
            onChange={(e) => setS19VoucherNo(e.target.value)}
            placeholder="e.g. PV-2026-001"
            className={inp}
            style={{ borderColor: s19VoucherNo ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            type="date"
            value={s19EntryDate}
            onChange={(e) => setS19EntryDate(e.target.value)}
            className={inp}
            style={{ borderColor: s19EntryDate ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          ...
          <input
            value={s19LedgerName}
            onChange={(e) => setS19LedgerName(e.target.value)}
            placeholder="e.g. Purchase A/c"
            className={inp}
            style={{ borderColor: s19LedgerName ? 'var(--border)' : '#FCA5A5' }}
          />
        </div>
        <div>
          <label style={labelStyle}>Vendor Ledger *</label>
          <input
            value={s19VendorLedger}
            onChange={(e) => setS19VendorLedger(e.target.value)}
            placeholder="Vendor ledger name"
            className={inp}
            style={{
              borderColor: s19VendorLedger ? 'var(--border)' : '#FCA5A5',
            }}
          />
        </div>
        <div>
          ...
          <input
            value={s19PurchaseLedger}
            onChange={(e) => setS19PurchaseLedger(e.target.value)}
            placeholder="Purchase ledger name"
            className={inp}
            style={{
              borderColor: s19PurchaseLedger ? 'var(--border)' : '#FCA5A5',
            }}
          />
        </div>
        <div>
          ...
          <input
            value={s19GstLedger}
            onChange={(e) => setS19GstLedger(e.target.value)}
            placeholder="GST input ledger"
            className={inp}
            style={{ borderColor: 'var(--border)' }}
          />
        </div>
      ...
      <ActionRow
        actions={[
          {
            label: 'Approve → Bill Approval L1',
            action: 'APPROVE',
            color: '#059669',
            loading: actionLoading,
            disabled: !validation.ok,
...
function StageBillApproval({
  ...
  const responsible =
    procurement.currentStage === 20 ? 'Pramod Kumar' : 'Neetu Singh';
  const remarksOk = remarksText.trim().length >= 3;
  ...
  const totalPO = poItems.reduce(
    (s, i) => s + parseFloat(i.poRate || '0') * (i.quantity || 0),
    0
  );
  const billAmt = parseFloat(
    meta16?.invoiceAmount || meta18?.invoiceAmount || '0'
  );
    ...
    <div>
      ...
      <div
        style={{
          ...
          padding: '10px 14px',
          borderRadius: 8,
          background: level === 'L1' ? '#EFF6FF' : '#F5F3FF',
          border: `1px solid ${level === 'L1' ? '#BFDBFE' : '#DDD6FE'}`,
        }}
      >
        <div
          style={{
            ...
            height: 36,
            borderRadius: '50%',
            background: level === 'L1' ? '#3B82F6' : '#7C3AED',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            color: '#fff',
        ...
        <div>
          <div style={{ fontSize: 12, fontWeight: 700 }}>
            Bill Approval — {level === 'L1' ? 'Level 1' : 'Level 2'}
          </div>
          <div style={{ fontSize: 11, color: 'var(--text-muted)' }}>
            Approver: {responsible} · Ref: {procurement.referenceNo}
          </div>
        </div>
        <div
          style={{
            ...
            padding: '6px 12px',
            borderRadius: 6,
            background: netPayable > 0 ? '#F0FDF4' : 'var(--surface2)',
            border: '1px solid var(--border)',
            fontSize: 12,
            fontWeight: 800,
            color: '#059669',
      ...
      <POReviewSection title="2. Store Check">
        {meta2?.itemChecks?.length > 0 ? (
          <table className="ifh-table">
            <thead>
              <tr style={{ background: 'var(--surface2)' }}>
                {['Item', 'Required', 'Available', 'Short Qty', 'Decision'].map(
                  (h) => (
                    <th key={h}>{h}</th>
                  )
                )}
      ...
      <POReviewSection title="6. Purchase Order">
        ...
        >
          ...
          <KV
            ...
            value={
              totalPO > 0
                ? `${poCurr} ${totalPO.toLocaleString('en-IN', { minimumFractionDigits: 2 })}`
                : undefined
            }
          />
        </div>
      ...
      <POReviewSection title="7. Material Receipt (GRN)">
        ...
        {stage(11)?.remarks && (
          <KV label="Receipt Remarks" value={stage(11)?.remarks} />
        )}
      </POReviewSection>
      ...
      <POReviewSection title="8. Material Inspection">
        ...
        >
          <KV
            label="QC-1 Result"
            value={
              meta12 ? (meta12.allPassed ? 'PASSED' : 'FAILED') : undefined
            }
          />
          ...
          <KV
            label="QC-2 Result"
            value={
              meta13 ? meta13.qcStatus || stage(13)?.actionTaken : undefined
            }
          />
          <KV label="QC-2 Remarks" value={stage(13)?.remarks} />
          <KV
            label="Final QC Result"
            value={
              meta14
                ? meta14.finalQcStatus || stage(14)?.actionTaken
                : undefined
            }
          />
      ...
      <POReviewSection title="9. Financial Stages">
        ...
        >
          ...
          <KV
            label="Bill Date"
            value={meta16?.billDate ? fmtDate(meta16.billDate) : undefined}
          />
          <KV
          ...
          <KV
            label="Due Date"
            value={meta18?.dueDate ? fmtDate(meta18.dueDate) : undefined}
          />
        </div>
        {stage(17)?.remarks && (
          <KV
            label="Purchase Verification Remarks"
            value={stage(17)?.remarks}
          />
        )}
        {stage(18)?.remarks && (
          <KV label="Bill Creation Remarks" value={stage(18)?.remarks} />
        )}
        {meta19 && (
          <div
            style={{
          ...
          >
            ...
            >
              ...
              <KV
                label="Entry Date"
                value={meta19.entryDate ? fmtDate(meta19.entryDate) : undefined}
              />
      ...
      >
        ...
        >
          Financial Approval Decision — {level === 'L1' ? 'Level 1' : 'Level 2'}{' '}
          · Net Payable:{' '}
...
function StagePaymentAdvice({
  ...
  const billAmt = parseFloat(
    meta18?.invoiceAmount || meta16?.invoiceAmount || '0'
  );
  ...
  const prereqLabels: Record<keyof typeof prereqs, string> = {
    ...
    tallyDone: 'Tally Entry Completed',
    billL1Approved: 'Bill Approval L1 Approved',
    billL2Approved: 'Bill Approval L2 Approved',
    vendorAvailable: 'Vendor Details Available',
  };
  ...
  const validation = validateFields([
    ...Object.entries(prereqs).map(([k, v]) => ({
      label: prereqLabels[k as keyof typeof prereqs],
      valid: v,
    })),
    ...
    <div>
      ...
      >
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 800, color: '#065F46' }}>
            Payment Advice — Final Release
          </div>
          <div style={{ fontSize: 11, color: '#047857' }}>
            Ref: {procurement.referenceNo} · Vendor: {vendorName || '—'}
          </div>
        </div>
        <div style={{ marginLeft: 'auto', textAlign: 'right' as const }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 800, color: '#059669' }}>
            {poCurr}{' '}
            {netPayment.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
          </div>
        </div>
      </div>
      ...
      >
        <div
          style={{
            padding: '8px 14px',
            background: allPrereqs ? '#F0FDF4' : '#FEF2F2',
            borderBottom: '1px solid var(--border)',
            fontSize: 11,
            fontWeight: 700,
            textTransform: 'uppercase',
            letterSpacing: '0.05em',
            color: allPrereqs ? '#065F46' : '#DC2626',
          }}
        >
          {allPrereqs
        ...
        >
          {Object.entries(prereqs).map(([k, v]) => (
            ...
            >
              ...
              >
                {prereqLabels[k as keyof typeof prereqs]}
              </span>
            </div>
          ))}
        </div>
      ...
      <POReviewSection title="Procurement Journey Summary">
        ...
        >
          ...
          <KV
            label="Vendor"
            value={meta6?.poItems?.[0]?.vendor || meta16?.vendorName}
          />
          <KV
            label="Total PO Value"
            value={
          ...
          <KV
            label="Bill Number"
            value={meta18?.billNumber || meta16?.billNumber}
          />
      ...
      <POReviewSection title="Workflow Timeline">
        <table className="ifh-table">
          <thead>
            <tr style={{ background: 'var(--surface2)' }}>
              {['Stage', 'Status', 'Completed', 'TAT', 'Remarks'].map((h) => (
                <th key={h}>{h}</th>
              ))}
            </tr>
          </thead>
        ...
        <div style={{ padding: 14 }}>
          ...
          >
            <div>
              ...
              <input
                value={adviceNo}
                onChange={(e) => setAdviceNo(e.target.value)}
                placeholder="PA-2026-XXXX"
                className={inp}
                style={{ borderColor: adviceNo ? 'var(--border)' : '#FCA5A5' }}
              />
            </div>
            <div>
              ...
              <input
                ...
                className={inp}
                style={{ borderColor: payDate ? 'var(--border)' : '#FCA5A5' }}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                className={inp}
                style={{
                  borderColor: vendorName ? 'var(--border)' : '#FCA5A5',
                }}
              />
            </div>
            <div style={{ gridColumn: 'span 2' }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="VB-XXXX"
                className={inp}
                style={{ borderColor: invoiceNo ? 'var(--border)' : '#FCA5A5' }}
              />
            </div>
            <div>
              <label style={labelStyle}>PO Number *</label>
              <input
                ...
                placeholder="PO-XXXX"
                className={inp}
                style={{ borderColor: poNo ? 'var(--border)' : '#FCA5A5' }}
              />
            </div>
            <div>
              <label style={labelStyle}>Bill Number</label>
            ...
            <div>
              ...
              <input
                ...
                className={inp}
                style={{
                  borderColor: tallyVoucher ? 'var(--border)' : '#FCA5A5',
                }}
              />
            </div>
            <div>
              ...
              <input
                ...
                className={inp}
                style={{
                  borderColor: payable > 0 ? 'var(--border)' : '#FCA5A5',
                }}
              />
            </div>
            <div>
      ...
      >
        ...
        >
          🟢 Final Payment Release — Workflow will be marked COMPLETED and
        ...
        <div style={{ marginTop: 10 }}>
          ...
          <ActionRow
            actions={[
              {
                label: '✓ Approve Payment → Release & Archive',
                action: 'APPROVE',
                color: '#059669',
                loading: actionLoading,
                disabled: !validation.ok,
  ...
  return (
    <div className="space-y-1">
      ...
      <ActionRow
        actions={[
          {
            label: 'Submit & Move Forward',
            action: 'SUBMIT',
            color: '#059669',
            loading: actionLoading,
            disabled: !remarksText,
