...
export default function ProfileCharts({ charts }: { charts: any }) {
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 20 }}>Advanced Charts & Trends</h2>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
        <div style={{ padding: 24, border: '1px solid var(--border)', borderRadius: 8 }}>
          <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 16 }}>Procurement Activity (Last 6 Months)</h3>
        ...
        <div style={{ padding: 24, border: '1px solid var(--border)', borderRadius: 8 }}>
          <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 16 }}>Approval Trend (Last 6 Months)</h3>
          <div style={{ width: '100%', height: 300 }}>
            <ResponsiveContainer>
        ...
        <div style={{ padding: 24, border: '1px solid var(--border)', borderRadius: 8, gridColumn: '1 / -1' }}>
          <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 16 }}>Login Trend</h3>
