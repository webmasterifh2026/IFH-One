...
const ProfileCharts = dynamic(
  () => import('@/components/profile/ProfileCharts'),
  {
    ssr: false,
    loading: () => (
...
export default function ProfilePage() {
  ...
  async function loadAll() {
    try {
      ...
      const [st, ac, an, sess, perm, ch, ach] = await Promise.all([
        ...
        apiFetch(`/users/${user?.id}/permissions`).catch(() => ({
          roles: [],
          permissions: [],
        })),
  ...
  async function revokeSession(sessionId: string) {
    ...
    try {
      await apiFetch(`/users/${user?.id}/sessions/${sessionId}`, {
        method: 'DELETE',
      });
      await loadAll();
    } catch (e) {
          ...
          {activeTab === 'personal' && (
            <div>
              ...
              <form
                ...
                style={{ display: 'grid', gap: 24, maxWidth: 700 }}
              >
                <div
                  style={{
                    display: 'grid',
          ...
          {activeTab === 'approvals' && (
            <div>
              ...
              >
                ...
                >
                  There are no items pending your approval right now.
                </p>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 14, fontWeight: 500, color: '#10B981' }}
                  >
                    Active
                  </div>
                </div>
            ...
            <div>
              ...
              >
                {[
                  ...
                  {
                    title: 'Documentation',
                    desc: 'Read the detailed system manual.',
                  },
                  { title: 'Report Bug', desc: 'Submit an issue to IT.' },
                  {
                    title: 'Contact Administrator',
                    desc: 'Request help from your admin.',
                  },
                ].map((item) => (
                  <div
                    key={item.title}
