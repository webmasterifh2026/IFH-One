...
export default function DashboardPage() {
  ...
  const activePipeline =
    procStats?.stagePipeline?.filter((s) => s.count > 0) ?? [];
  ...
  return (
    <div className="page-content" style={{ maxWidth: 1440, margin: '0 auto' }}>
        ...
        {loading
          ? Array(8)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="ifh-card p-5 animate-pulse"
                  style={{ minHeight: 108 }}
                >
                  <div
                    style={{
          ...
          <EnterpriseCard noPadding className="h-full flex flex-col">
            ...
            >
              <div>
                ...
                >
                  {totalActive} records active across {activePipeline.length}{' '}
                  stages
                </div>
              </div>
              <Link
            ...
            <div style={{ padding: '16px 20px', flex: 1 }}>
              {STAGE_GROUPS.map((group) => {
                const stages =
                  procStats?.stagePipeline?.filter((s) =>
                    group.stages.includes(s.stage)
                  ) ?? [];
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {stages.map((s) => (
                        <Link
                          ...
                          href={
                            WORKFLOW_ROUTES[
                              s.stage as keyof typeof WORKFLOW_ROUTES
                            ]?.list ?? '/procurement'
                          }
        ...
        <div className="flex flex-col gap-5">
          ...
          <EnterpriseCard noPadding>
            ...
            <div style={{ padding: '10px 12px' }}>
              {[
                {
                  label: 'Create New Indent',
                  href: '/indents/new',
                  icon: FileText,
                  primary: true,
                },
                {
                  label: 'Indent Lifecycle Tracker',
      ...
      <div style={{ marginTop: 32, textAlign: 'center' }}>
        <span
          style={{ fontSize: 11, color: 'var(--text-faint)', fontWeight: 500 }}
        >
