...
export default function ItemsPage() {
    ...
    try {
      ...
      if (showModal === 'create') {
        ...
        const res = await apiFetch(
          `/skus/${encodeURIComponent(currentItem.id)}`,
          {
            method: 'PUT',
            body: JSON.stringify({
              itemCode: formData.itemCode,
  ...
  return (
    <div className="page-content">
      ...
      <div
        className="ifh-card"
        style={{ padding: '12px 14px', marginBottom: 16, marginTop: 20 }}
      >
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          >
            <button
              ...
              style={{
                background: showFilters ? 'var(--surface2)' : 'transparent',
                height: 36,
                padding: '0 14px',
                borderRadius: 8,
                display: 'inline-flex',
            ...
            >
              ...
              <span>Filters</span>
              {(filterUom || filterCategory || filterStatus) && (
                <span
                  style={{
                    width: 8,
                    height: 8,
              ...
              >
                ...
                {qfRecent && (
                  <button
                    ...
                    onClick={async () => {
                      await apiFetch('/skus/clear-recent-views', {
                        method: 'POST',
                      });
                      setQfRecent(false);
                      setPage(1);
                ...
                <button
                  ...
                  onClick={() => {
                    setFilterUom(filterUom === 'missing' ? '' : 'missing');
                    setPage(1);
                  }}
                >
                  Missing UOM
            ...
            <table className="ifh-table">
              <thead>
                <tr>
                  ...
                  <th onClick={() => handleSort('subGroup')}>
                    Sub Group <SortIcon col="subGroup" />
                  </th>
                  <th onClick={() => handleSort('uom')}>
                    UOM <SortIcon col="uom" />
                  </th>
                      ...
                      <td>
                        <span
                          style={{
                            padding: '4px 8px',
                            background:
                              i.status === 'Active' ? '#dcfce7' : '#f1f5f9',
                            color:
                              i.status === 'Active' ? '#166534' : '#475569',
                            borderRadius: 4,
                            fontSize: 11,
                            fontWeight: 500,
                          }}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {showModal === 'create'
                  ? 'Create Item'
                  : showModal === 'edit'
                    ? `Edit Item: ${currentItem?.itemCode}`
                    : showModal === 'insights'
                      ? `Item Insights: ${currentItem?.itemCode}`
                      : 'Delete Item'}
              </h3>
              <button
                onClick={closeModal}
              ...
              {showModal === 'delete' && currentItem && (
                <div>
                  ...
                  >
                    ...
                    <br />
                    <br />
                    This action will remove the item from the master database
                    but will <strong style={{ color: '#dc2626' }}>
                      not
                    </strong>{' '}
                    affect existing procurement history. This action cannot be
                    undone.
                  </p>
                </div>
              )}
                  ...
                  {insightsLoading ? (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {insights.totalQuantityRequested.toLocaleString()}{' '}
                          <span
                            style={{
                              fontSize: 14,
                              color: 'var(--text-muted)',
                      ...
                      >
                        ...
                        {insights.mostFrequentVendors?.length > 0 ? (
                          ...
                          >
                            {insights.mostFrequentVendors.map(
                              (v: string, i: number) => (
                                <span
                                  key={i}
                                  style={{
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ textAlign: 'right' }}>
                            ...
                            >
                              {insights.currentActiveStages?.length > 0
                                ? insights.currentActiveStages
                                    .map((s: number) => `S${s}`)
                                    .join(', ')
                                : 'None'}
                            </div>
            ...
            {duplicateWarning.length > 0 && (
              ...
              >
                <h4
                  style={{ margin: '0 0 8px', color: '#DC2626', fontSize: 14 }}
                >
                  Possible Duplicates Detected
                </h4>
                <p
                  style={{ margin: '0 0 12px', fontSize: 13, color: '#991B1B' }}
                >
                  We found {duplicateWarning.length} existing item(s) that might
                  be duplicates. Do you still want to proceed?
                </p>
                <ul
                  style={{
                    margin: 0,
              ...
              {(showModal === 'create' || showModal === 'edit') && (
                <button
                  ...
                  style={{
                    ...
                    background:
                      duplicateWarning.length > 0 ? '#DC2626' : undefined,
                  }}
                  onClick={() => {
                  ...
                  disabled={
                    modalLoading || !formData.itemCode || !formData.description
                  }
                >
                  {modalLoading
                    ? 'Saving...'
