  ...
  const modules = [
    {
      ...
      title: 'Dashboard',
      desc: 'Real-time KPIs and operational overview',
      color: '#3B82F6',
    },
    {
      icon: ShoppingCart,
      title: 'Procurement',
      desc: 'Complete procurement lifecycle management',
      color: '#10B981',
    },
    {
      icon: Package,
      title: 'Items',
      desc: 'Master inventory with 18,000+ SKUs',
      color: '#8B5CF6',
    },
    {
      icon: Briefcase,
      title: 'Projects',
      desc: 'Project-based budget tracking',
      color: '#F59E0B',
    },
    {
      icon: Building2,
      title: 'Vendors',
      desc: 'Vendor database and performance analytics',
      color: '#EC4899',
    },
    {
      icon: Users,
      title: 'Users',
      desc: 'User management with RBAC controls',
      color: '#6366F1',
    },
  ];
        ...
        >
          <div
            style={{
              ...
              boxShadow: '0 4px 12px rgba(15, 123, 69, 0.2)',
            }}
          >
      ...
      >
        ...
        <div
          style={{
            ...
            height: '40vw',
            background:
              'radial-gradient(circle, rgba(15,123,69,0.06) 0%, rgba(255,255,255,0) 70%)',
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 20, marginBottom: 40 }}>
            ...
            >
              ...
              >
                Version v{APP_VERSION} is now live
              </span>
            ...
            >
              ...
              <span
                style={{
                  ...
                  letterSpacing: '-0.05em',
                  lineHeight: 0.9,
                  textShadow: '0 20px 40px rgba(15,123,69,0.1)',
                }}
              >
                Procurement.
              </span>
            ...
            >
              One unified workspace designed specifically for enterprise
              procurement teams. Manage indents, enforce strict RBAC approvals,
              and track multi-million dollar budgets with absolute clarity.
            </p>
          ...
          >
            ...
            >
              ...
              >
                <CheckCircle
                  style={{ width: 20, height: 20, color: '#0F7B45' }}
                />
              </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <TrendingUp
                    style={{ width: 18, height: 18, color: '#0F172A' }}
                  />
                </div>
                <span
                  style={{ fontSize: 13, color: '#059669', fontWeight: 700 }}
                >
                  +12%
                </span>
              </div>
        ...
        >
          <div
            style={{
              ...
              border: '1px solid rgba(226, 232, 240, 0.8)',
              boxShadow:
                '0 50px 100px -20px rgba(15, 23, 42, 0.15), 0 30px 60px -30px rgba(15, 23, 42, 0.1)',
              overflow: 'hidden',
              position: 'relative',
                ...
                >
                  <div
                    style={{
                      ...
                      alignItems: 'center',
                      justifyContent: 'center',
                      boxShadow: '0 4px 12px rgba(15,123,69,0.3)',
                    }}
                  >
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: 6,
                        background:
                          i === 0 ? '#0F7B45' : 'rgba(255,255,255,0.1)',
                      }}
                    />
                    {item}
                  </div>
        ...
        >
          <div>
            ...
            >
              ...
              IFH One centralizes every procurement stage into a single, highly
              governed workspace.
            </p>
            <div
              style={{
              ...
              {[
                {
                  ...
                  desc: 'Workflows transition instantly between departments without manual intervention.',
                },
                {
                  title: 'Live Budget Tracking',
                  desc: 'Real-time financial visibility prevents overspending before it happens.',
                },
                {
                  title: 'Immutable Audit Logs',
                  desc: 'Every action, approval, and rejection is tracked permanently for perfect compliance.',
                },
              ].map((benefit) => (
                <div
                  key={benefit.title}
                ...
                >
                  ...
                  >
                    <CheckCircle
                      style={{ width: 16, height: 16, color: '#0F7B45' }}
                    />
                  </div>
                  <div>
                    <div
      ...
      >
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 120 }}>
            ...
            >
              A flawless, connected experience mapping the entire procurement
              lifecycle. From the moment an indent is raised to the final
              payment dispatch.
            </p>
          </div>
          ...
          <div style={{ position: 'relative', padding: '0 40px' }}>
            ...
            >
              <path
                d="M 100,40 C 300,40 300,160 500,160 C 700,160 700,-40 900,-40 C 1100,-40 1100,80 1300,80"
                fill="none"
      ...
      <Section id="search">
        ...
        >
          ...
          <p style={{ fontSize: 22, color: '#64748B', lineHeight: 1.6 }}>
            A powerful, intelligent search engine that indexes your entire
            procurement ecosystem. From SKUs to specific vendor invoices.
          </p>
        </div>
        ...
        <div
          style={{
            ...
            borderRadius: 32,
            border: '1px solid #E2E8F0',
            boxShadow: '0 50px 100px rgba(15, 23, 42, 0.1)',
            overflow: 'hidden',
          }}
        >
          <div
          ...
          >
            ...
            <span style={{ fontSize: 24, color: '#0F172A', fontWeight: 600 }}>
              6205 Bearing...
            </span>
            <span
              style={{
          ...
          <div style={{ display: 'flex', height: 480 }}>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    borderLeft:
                      i === 1 ? '4px solid #0F7B45' : '4px solid transparent',
                    cursor: 'pointer',
                    boxShadow: i === 1 ? '0 4px 12px rgba(0,0,0,0.02)' : 'none',
                  }}
                >
                  {c}
                </div>
            ...
            >
              ...
              {[
                {
                  title: 'SKU-2847 — Bearing Assembly 6205-2RS',
                  desc: 'Mechanical • In Stock: 45',
                },
                {
                  title: 'SKU-3102 — Deep Groove Ball Bearing 6205',
                  desc: 'Electrical • In Stock: 12',
                },
                {
                  title: 'SKU-1593 — Bearing Housing Assembly Unit',
                  desc: 'Maintenance • In Stock: 0',
                },
              ].map((r, i) => (
                <div
                  key={i}
                  style={{
                    ...
                    border:
                      i === 0 ? '1px solid #E2E8F0' : '1px solid transparent',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 20,
                    cursor: 'pointer',
                  ...
                  onMouseEnter={(e) => {
                    if (i !== 0) e.currentTarget.style.background = '#FAFAFA';
                  }}
                  onMouseLeave={(e) => {
                    if (i !== 0)
                      e.currentTarget.style.background = 'transparent';
                ...
                >
                  ...
                  >
                    <Package
                      style={{ width: 24, height: 24, color: '#0F7B45' }}
                    />
                  </div>
                  <div>
                    <div
        ...
        >
          ...
          <div
            style={{
              ...
              height: '200%',
              background:
                'radial-gradient(ellipse, rgba(16, 185, 129, 0.25) 0%, transparent 60%)',
              pointerEvents: 'none',
              filter: 'blur(40px)',
            }}
          />
          <div
            style={{
              ...
              height: '200%',
              background:
                'radial-gradient(ellipse, rgba(59, 130, 246, 0.2) 0%, transparent 60%)',
              pointerEvents: 'none',
              filter: 'blur(40px)',
            }}
          />
          ...
          <div style={{ position: 'relative', zIndex: 10 }}>
            ...
            >
              <Link
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform =
                    'translateY(-4px) scale(1.02)';
                  e.currentTarget.style.boxShadow =
                    '0 30px 60px rgba(255,255,255,0.25)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0) scale(1)';
                  e.currentTarget.style.boxShadow =
              ...
              >
                Sign In <ArrowRight style={{ width: 24, height: 24 }} />
              </Link>
              <Link
                href="/indents/new"
                onClick={handleCreateIndent}
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          >
            ...
            <div style={{ gridColumn: 'span 2' }}>
              ...
              >
                <div
                  style={{
                    ...
                    alignItems: 'center',
                    justifyContent: 'center',
                    boxShadow: '0 8px 20px rgba(15, 123, 69, 0.2)',
                  }}
                >
                  <Layers style={{ width: 20, height: 20, color: '#fff' }} />
                </div>
              ...
              >
                Enterprise procurement management and workflow automation
                platform for Intensiv-Filter Himenviro.
              </p>
            </div>
            {/* Platform */}
            <div>
            ...
            <div>
              ...
              {[
                { l: 'Contact Admin', h: 'mailto:admin@if-himenviro.in' },
                { l: 'Sign In', h: '/login' },
                { l: 'Create Indent', h: '/indents/new' },
              ].map((l) => (
                <a
                  key={l.l}
                  href={l.h}
          ...
          >
            <span style={{ fontSize: 15, color: '#94A3B8', fontWeight: 600 }}>
              © 2026 Intensiv-Filter Himenviro Pvt. Ltd.
            </span>
