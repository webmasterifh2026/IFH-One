      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your quotation for <strong>{rfqNumber}</strong> has been received
            successfully.
          </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 text-sm">
            Your quotation for <strong>{rfqNumber}</strong> has already been
                    ...
                    >
                      ...
                      <td className="px-3 py-3">
                        <input
                          ...
                          onChange={(e) =>
                            updateItem(idx, 'gstPercentage', e.target.value)
                          }
                          className="w-16 text-right px-2 py-1 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-gray-400"
                        />
                      </td>
                      ...
                      <td className="px-3 py-3">
                        <input
                          ...
                          value={item.delivery}
                          onChange={(e) =>
                            updateItem(idx, 'delivery', e.target.value)
                          }
                      ...
                      <td className="px-3 py-3">
                        <input
                          ...
                          onChange={(e) =>
                            updateItem(idx, 'itemRemarks', e.target.value)
                          }
                ...
                {[
                  {
                    ...
                    key: 'deliveryBasis',
                    placeholder: 'e.g. Ex-Works, FOR, CIF',
                  },
                  {
                    label: 'Payment Terms',
                    key: 'paymentTerms',
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                {items.length} item(s) · {rfq?.rfqNumber}
              </p>
            </div>
            <button
