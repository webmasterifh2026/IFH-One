...
export const STAGE_TAT: Record<number, StageTATConfig> = {
  ...
  2: {
    ...
    tatHours: 4,
    responsible: ['Shiv Dayal Sharma', 'Pankaj Kumar'],
  },
  ...
  8: {
    ...
    name: 'PO Approval L2',
    tatHours: 6,
    responsible: ['Ankur Gupta'],
  },
  9: {
    stage: 9,
    name: 'Vendor Acceptance',
    tatHours: 20,
    responsible: ['Neetu Singh'],
  },
  10: {
    stage: 10,
    name: 'Vendor Follow Up',
    tatHours: 12,
    responsible: ['Priyanka Pal'],
  },
  11: {
    stage: 11,
    name: 'Material Receipt',
    tatHours: 24,
    responsible: ['Shiv Dayal Sharma', 'Shivam Namdev', 'Anushka Kamboj'],
  },
  12: {
    stage: 12,
    name: 'Material Inspection',
    tatHours: 4,
    responsible: ['Saurabh', 'Shivam Namdev', 'Anushka Kamboj'],
  },
  13: {
    stage: 13,
  ...
  16: {
    ...
    tatHours: 6,
    responsible: ['Pankaj Kumar', 'Anushka Kamboj'],
  },
  17: {
    stage: 17,
    name: 'Bill To Purchase',
    tatHours: 8,
    responsible: ['Pankaj Kumar', 'Atul Tyagi', 'Anushka Kamboj'],
  },
  18: {
    stage: 18,
    name: 'Bill Creation',
...
function isWorkingDay(date: Date): boolean {
  ...
  // Saturday
  const workingSats = workingSaturdaysInMonth(
    date.getFullYear(),
    date.getMonth()
  );
