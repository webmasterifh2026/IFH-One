...
import { poApprovalL1Config, poApprovalL2Config } from './stage-configs/s7-s8-po-approval';
...
import { materialInspectionConfig, secondaryInspectionConfig, finalInspectionConfig } from './stage-configs/s12-s13-s14-inspections';
...
import { billApprovalL1Config, billApprovalL2Config } from './stage-configs/s20-s21-bill-approval';
...
export function getStageConfigByNumber(stageNumber: number): StageConfig | undefined {
