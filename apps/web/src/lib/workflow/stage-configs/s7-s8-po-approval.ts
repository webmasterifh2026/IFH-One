...
function poApproval(level: 1 | 2, stageNumber: number, slug: string): StageConfig {
  return {
    stageNumber,
    slug,
...
export const poApprovalL1Config: StageConfig = poApproval(1, 7, 'po-approval-l1');
export const poApprovalL2Config: StageConfig = poApproval(2, 8, 'po-approval-l2');
