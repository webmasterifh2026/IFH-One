...
export const debitNoteConfig: StageConfig = {
  ...
  description:
    'Prepare debit note after all three inspections failed. Submitting closes the workflow as REJECTED — billing stages do NOT execute.',
  ...
  validationRules: [
    {
      key: 'debitNoteStatusProvided',
      label: 'Debit Note Status Provided',
      check: (ctx) => !!ctx.fieldValues.debitNoteStatus,
    },
    {
      key: 'remarksProvided',
