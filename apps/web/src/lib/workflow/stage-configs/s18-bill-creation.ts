...
export const billCreationConfig: StageConfig = {
  ...
  shortName: 'Bill + GRN',
  description:
    'Create and record the final bill with GRN reconciliation in the system.',
  ...
  validationRules: [
    ...
    {
      key: 'dueDateProvided',
      label: 'Due Date Provided',
      check: (ctx) => !!ctx.fieldValues.dueDate,
    },
    {
      key: 'billRemarksProvided',
      label: 'Bill Remarks Provided',
