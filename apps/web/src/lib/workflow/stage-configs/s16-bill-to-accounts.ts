...
export const billToAccountsConfig: StageConfig = {
  ...
  validationRules: [
    {
      key: 'grnCompleted',
      label: 'Material Receipt (GRN) Completed',
    ...
    {
      key: 'vendorNameProvided',
      label: 'Vendor Name Provided',
      check: (ctx) => !!ctx.fieldValues.vendorName,
    },
    {
      key: 'billNumberProvided',
      label: 'Vendor Bill Number Provided',
      check: (ctx) => !!ctx.fieldValues.billNumber,
    },
    {
      key: 'billDateProvided',
      label: 'Bill Date Provided',
      check: (ctx) => !!ctx.fieldValues.billDate,
    },
    {
    ...
    {
      key: 'grnNumberProvided',
      label: 'GRN Number Provided',
      check: (ctx) => !!ctx.fieldValues.grnNumber,
    },
    {
      key: 'invoiceAmountProvided',
      label: 'Invoice Amount Provided',
      check: (ctx) => !!ctx.fieldValues.invoiceAmount,
    },
    {
      key: 'accountsRemarksProvided',
      label: 'Accounts Remarks Provided',
