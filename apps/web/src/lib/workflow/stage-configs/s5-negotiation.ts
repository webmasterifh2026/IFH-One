...
export const negotiationConfig: StageConfig = {
  ...
  description:
    'Final negotiation with vendor and decision on vendor selection.',
  ...
  validationRules: [
    {
      ...
      check: (ctx) =>
        Object.values(ctx.itemFieldValues).every(
          (v: any) => v.vendor && v.finalApprovedPrice && v.negotiationRemarks
        ),
    },
    {
      key: 'remarksProvided',
