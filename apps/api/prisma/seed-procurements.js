    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
            ...
            prisma.user.findFirst({
              where: {
                userRoles: {
                  some: {
                    roleId:
                      adminRole === null || adminRole === void 0
                        ? void 0
                        : adminRole.id,
                  },
                },
        ...
        case 7:
          ...
          if (stage === 23) status_1 = 'COMPLETED';
          if (Math.random() < 0.1) status_1 = 'HOLD';
          if (Math.random() < 0.05) status_1 = 'REJECTED';
          createdAt = new Date();
          ...
          return [
            ...
            prisma.procurement.create({
              data: {
                ...
                description:
                  'This is a simulated procurement request for Batch '.concat(
                    i,
                ...
                status: status_1,
                departmentId:
                  depts.length > 0 ? depts[i % depts.length].id : null,
                vendorId:
                  vendors.length > 0 ? vendors[i % vendors.length].id : null,
                vendorName:
                  vendors.length > 0
                    ? vendors[i % vendors.length].vendorName
                    : null,
                createdAt: createdAt,
                updatedAt: new Date(),
              },
        ...
        case 13:
          ...
          return [
            4 /*yield*/,
            prisma.procurementStage.create({
              data: {
                procurementId: p.id,
                stageNumber: s,
                stageName: stageName,
                status:
                  isCurrent &&
                  (status_1 === 'IN_PROGRESS' || status_1 === 'HOLD')
                    ? 'PENDING'
                    : 'APPROVED',
                startedAt: createdAt,
        ...
        case 14:
          ...
          return [
            4 /*yield*/,
            prisma.procurementHistory.create({
              data: {
                procurementId: p.id,
                stageNumber: s,
                action: 'APPROVED',
