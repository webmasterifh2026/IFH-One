...
const PERMISSIONS = [
  ...
  },
  {
    ...
    description: 'Deactivate or lock users',
  },
  {
    module: 'User Management',
  ...
  // Indents
  {
    ...
    key: 'indent.view',
    name: 'View Indents',
    description: 'View material indents',
  },
  {
    module: 'Indents',
    key: 'indent.create',
    name: 'Create Indents',
    description: 'Create new indents',
  },
  {
    module: 'Indents',
    key: 'indent.edit',
    name: 'Edit Indents',
    description: 'Edit indents',
  },
  {
    module: 'Indents',
    key: 'indent.cancel',
    name: 'Cancel Indents',
    description: 'Cancel existing indents',
  },
  ...
  // RFQs
  {
    ...
    key: 'rfq.view',
    name: 'View RFQs',
    description: 'View Request for Quotations',
  },
  {
    module: 'RFQs',
    key: 'rfq.create',
    name: 'Create RFQs',
    description: 'Create new RFQs',
  },
  {
    module: 'RFQs',
    key: 'rfq.edit',
    name: 'Edit RFQs',
    description: 'Edit existing RFQs',
  },
  {
    module: 'RFQs',
    key: 'rfq.close',
    name: 'Close RFQs',
    description: 'Close or finalize RFQs',
  },
  ...
  },
  {
    ...
    description: 'Approve purchase orders for issue',
  },
  ...
  },
  {
    ...
    key: 'receipt.edit',
    name: 'Edit Receipts',
    description: 'Edit existing receipts',
  },
  ...
  // Gate Entry / Material Receipt
  {
    ...
    description: 'View gate entries, quantity checks, quality checks, and GRNs',
  },
  {
    module: 'Gate Entry',
    ...
    description:
      'Perform gate entry (Security Gate) — search PO, log vehicle, upload photos',
  },
  {
    module: 'Gate Entry',
    key: 'gate_entry.quantity_check',
    name: 'Quantity Verification',
    description: 'Perform quantity verification against invoice (Store)',
  },
  {
    module: 'Gate Entry',
    key: 'gate_entry.quality_check',
    name: 'Quality Inspection',
    description: 'Perform quality inspection — accept/reject/deviation (QC)',
  },
  {
    module: 'Gate Entry',
    key: 'gate_entry.allocate',
    name: 'Material Allocation',
    description:
      'Allocate accepted material to a storage location and trigger GRN',
  },
  ...
  },
  {
    ...
    description: 'Perform material inspections',
  },
  {
    module: 'Inspections',
    key: 'inspection.approve',
    name: 'Approve Inspections',
    description: 'Approve or reject inspected materials',
  },
  ...
  },
  {
    ...
    key: 'bill.create',
    name: 'Create Bills',
    description: 'Create new bills against POs',
  },
  {
    module: 'Billing',
    key: 'bill.edit',
    name: 'Edit Bills',
    description: 'Edit vendor bills',
  },
  {
    module: 'Billing',
    key: 'bill.approve',
  ...
  },
  {
    ...
    description: 'Approve scheduled payments',
  },
  {
    module: 'Payments',
    key: 'payment.release',
    name: 'Release Payments',
    description: 'Release actual payments to vendors',
  },
...
async function main() {
  ...
  const doerPermissions = allPermissions.filter((p) =>
    doerKeys.includes(p.key),
  );
